            ...
            <div class="tab">
                ...
                <div class="tab-content" >
                    ...
                    <h2 class="text-center">My Posts</h2>
                        ...
                        <a href="edit_news.php?id= <?php echo $row['id']?>  "> <button type="submit"id="right" class="fa fa-pencil-square-o " aria-hidden="true">&nbsp;</button></a>
                                        ...
                                        <ul class="news list-unstyled">
                                            <li class="d-flex justify-content-between" > 
                                                <div class="left-col d-flex">
                                                    ...
                                                    <div class="title col-md-10">
                                                        <strong>
                                                            <h3><?php echo $row1['id']?>.<?php echo $row1['title']?></h3>
                                                            </strong>
                                                    </div> 
                                                    <div class="col-md-2" id="right">
                        <a href="edit_news.php?id= <?php echo $row1['id']?>  "> <button type="submit"id="right" class="fa fa-pencil-square-o " aria-hidden="true">&nbsp;</button></a>

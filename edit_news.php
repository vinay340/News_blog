...
<?php
   ...
   // echo "<pre>";print_r($_REQUEST);
       $post_id = $_REQUEST['edit_news'];
       // echo $post_id;
            //foreach($post_id as $i){
             //   if(isset($_REQUEST['edit_news'.$i]) ){  
               // $role = mysqli_real_escape_string($conn,$post_id);
        ...
        <div class="col-md-8 col-xs-12">
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <a  class="btn btn-default col-md-4 right cancel_button  " href="author_dashboard.php">CANCEL</a>
                </div>
            </form>
        </div>
    </div>
